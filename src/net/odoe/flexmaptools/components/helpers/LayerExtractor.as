package net.odoe.flexmaptools.components.helpers
{
	...
	public class LayerExtractor
	{
		 ...
		 * @param lyr
		 */
		public function extractLegend(lyr:ArcGISDynamicMapServiceLayer):void
		{
			visibleLayers=lyr.visibleLayers;
		...
		private function requestLegend(lyr:ArcGISDynamicMapServiceLayer):void
		{
			var service:HTTPService=getLegendService(lyr.url);
		...
		private function processResults(results:Array, lyr:ArcGISDynamicMapServiceLayer):void
		{
